...
Generated on: 2025-02-13 15:20:56
...
Version:            5.11.0
SyftVersion:        v1.13.1-0.20241021162740-c5fba2d0e463
BuildDate:          2024-10-25T18:30:34Z
GitCommit:          8b82bbb319d0e33becf1e3fabac11e31516df47c
...
Arguments:
  IMAGE:  The image to fetch the policy evaluation for (can be a digest, id or registry/repo:tag). If no tag supplied defaults to 'latest'
...
Flags:
  ...
  -t, --tag string              specify which tag is evaluated for a given image ID or Image digest
...
Flags:
      ...
      --exclude-existing-tags   indicates if you want to ignore the existing tags in the repository on the first execution
                                (env: ANCHORECTL_EXCLUDE_EXISTING_TAGS)
  -h, --help                    help for add
  -o, --output string           the format to show the results (allowable: [text json json-raw id]; env: ANCHORECTL_FORMAT) (default "text")
...
Flags:
  ...
  -o, --output string      the format to show the results (allowable: [text json id]; env: ANCHORECTL_FORMAT) (default "text")
      --role stringArray   the initial role(s) for the user. Defaults to (read-write) when not in the admin account.
                           (allowable: [account-user-admin full-control image-analyzer image-developer image-lifecycle inventory-agent policy-editor read-only read-write registry-editor repo-analyzer report-admin]; env: ANCHORECTL_USER_ROLE)
...
Flags:
  -a, --contains-account string   Filter the user groups to only those that contain the specified account
...
Available Commands:
  add         Add account and role(s) to this user group
  delete      Remove account and role(s) from this user group
...
```text
Add account and role(s) to this user group

Usage:
  anchorectl usergroup role add USER_GROUP FOR_ACCOUNT [flags]

Arguments:
  FOR_ACCOUNT:  The account
  USER_GROUP:  The name or uuid of the user group
...
Flags:
  ...
  -i, --input string       path to a JSON input file or - to read from stdin (env: ANCHORECTL_INPUT)
  -o, --output string      the format to show the results (allowable: [text json json-raw id]; env: ANCHORECTL_FORMAT) (default "text")
  -r, --role stringArray   The RBAC role(s) that will be associated with the specified account
                           (allowable: [account-user-admin full-control image-analyzer image-developer image-lifecycle inventory-agent policy-editor read-only read-write registry-editor repo-analyzer report-admin]; env: ANCHORECTL_ROLE)
...
```text
Remove account and role(s) from this user group

Usage:
  anchorectl usergroup role delete USER_GROUP FOR_ACCOUNT [flags]
